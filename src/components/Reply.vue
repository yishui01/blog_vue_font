<template>
    <!--评论框大部分抄自 https://github.com/xb2016/kratos-pjax 主题的评论框-->
    <div>
                    ...
                    <div style="display: flex">
                        ...
                        <div style="width: 100%;">
                                <textarea class="form-control" v-model="content"
                                          id="comment" placeholder="|´・ω・)ノ还不快点说点什么呀poi~"
                                          name="comment" rows="5" aria-required="true"
                                          required=""></textarea>
                            <!-- 表情-->
                            ...
                            <span v-if="item.type=='image'">
                                 <li @click="addOwO(t2.desc)" v-for="(t2,i2) in item.container" :key="i2"
                                     class="OwO-item" :title="t2.text"
                                     :desc="t2.desc">
                                     <a><img :src="t2.icon"></a>
                                </li>
                            </span>
                                 ...
                                 <li @click="addOwO(t2.desc)" v-for="(t2,i2) in item.container" :key="i2"
                                    ...
                                    <div class="OwO-bar">
                                        <ul class="OwO-packages">
                                            <li v-for="(item,key,index) in owo" :key="index"
                                                :class="{'OwO-package-active':owoTab == index}"
                                                @click="owoTab=index">
                                                <span>{{key}}</span></li>
                                        </ul>
                                    </div>
...
<style scoped>
    * {
    ...
    /***以下css全部抄自 https://github.com/xb2016/kratos-pjax/blob/master/static/css/kratos.min.css  ***/
    @-webkit-keyframes a {
        2% {
    ...
    #respond .comment .form-control {
        background: url(https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@0.4.1/static/images/comment.png) right bottom no-repeat
    }
    ...
    #respond .must-log-in, .must-log-in a {
        color: #555
    }
