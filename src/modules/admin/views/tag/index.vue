...
import { getListApi, createApi, updateApi, deleteApi } from '@/api/admin/tag'
    ...
    return {
      ...
      filterInfo: {
        ...
        list: [
          ...
          { type: 'input', label: '标签名称', value: 'keyword'},
      ...
      tableInfo: {
        ...
        handle: {
          ...
          btList: [
            ...
            //{ label: '启用', type: 'success', icon: 'el-icon-albb-process', event: 'status', loading: 'statusLoading', show: true, slot: true },
